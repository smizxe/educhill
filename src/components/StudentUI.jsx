        ...
        <section className="w-full max-w-7xl mx-auto mb-32 px-4 scroll-enter">
            ...
            <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-serif text-slate-900 mb-4">
                    {content.titleStart} <span className="glass-box px-4 mx-2"><span className="text-emerald-500 italic font-medium animate-glow-loop">{content.titleHighlight}</span></span>
                </h2>
