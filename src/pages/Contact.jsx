...
export const Contact = () => {
    useEffect(() => {
        // Since we are pushing content, we might need to scroll to top on route change
        window.scrollTo(0, 0);
    }, []);

    return (
        <div id="app-container" className="pt-8 pb-20 px-4 flex flex-col items-center justify-center">
